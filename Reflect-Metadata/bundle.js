...
// // async function show() {
// //   var a = document.querySelector("#main") as HTMLElement | null;
// //   if (a) a.innerText = JSON.stringify(await getFetch());
// // }
// // show();
...
//   console.log("------------------------------------------------");
// }
// function paramLogger(target: any, name: string, indexParam: number) {
//   console.log("Param logger");
//   console.log(target);
//   console.log(name);
...
//   }
//   @methodLogger
//   display(@paramLogger ...args: any): void {
//     console.log(`Person name: ${this.name} - ${Person.own}`);
//   }
// }
...
// p.name = "Ha";
// console.log(p.name);
var RM = require("reflect-metadata");
...
},{"reflect-metadata":3}],3:[function(require,module,exports){
